...
from test_visual import test, parse_args  # 复用已有函数

# 1. 全局路径
DEV_JSON   = r"E:\IDADM\dataset\nq320k\dev.json"
PRED_JSON  = r"E:\IDADM\out\model-1-pre\top3_pred.json"
ANS_JSONL  = r"E:\IDADM\out\deepseek_answers.jsonl"
...
def main():
    ...
    # 3-6 保存 & 打印
    out_obj = {"query": query, "retrieve": retrieve, "prompt": prompt, "answer": answer}
